...
class MyApp(QWidget):
    ...
    def Dialog5(self):
        ...
        self.gbtn_non_sap = QPushButton('', self.dialog5)
        pixmap_bar = QPixmap(self.resource_path('./clear_files.png'))
        icon_bar = QIcon(pixmap_bar)
        self.gbtn_non_sap.setIcon(icon_bar)
        self.gbtn_non_sap.setIconSize(pixmap_bar.size())
        self.gbtn_non_sap.resize(110, 30)
        self.gbtn_non_sap.setStyleSheet('border : 0; background: transparent;')
        self.gbtn_non_sap.clicked.connect(self.dropFiles_Non_SAP)

        ### SAP=============================================================================
        ### 버튼 1 - Clear Files (SAP)
        self.gbtn = QPushButton('', self.dialog5)
        pixmap_bar = QPixmap(self.resource_path('./clear_files.png'))
        icon_bar = QIcon(pixmap_bar)
        self.gbtn.setIcon(icon_bar)
        self.gbtn.setIconSize(pixmap_bar.size())
        self.gbtn.resize(110, 30)
        self.gbtn.setStyleSheet('border : 0; background: transparent;')
    ...
    def Dialog12(self):
        ...
        ### 버튼 1 - Extract Data
        self.btn1 = QPushButton('', self.dialog12)
        pixmap_bar = QPixmap(self.resource_path('./extract_data.png'))
        icon_bar = QIcon(pixmap_bar)
        self.btn1.setIcon(icon_bar)
        self.btn1.setIconSize(pixmap_bar.size())
        self.btn1.resize(110, 30)
        self.btn1.setStyleSheet('border : 0; background: transparent;')
        self.btn1.clicked.connect(self.Thread11)

        ### 버튼 2 - Close
        self.btnDialog1 = QPushButton("", self.dialog12)
        pixmap_bar2 = QPixmap(self.resource_path('./close.png'))
        icon_bar2 = QIcon(pixmap_bar2)
        self.btnDialog1.setIcon(icon_bar2)
        self.btnDialog1.setIconSize(pixmap_bar2.size())
        ...
        self.cursorFile = QPushButton('')
        pixmap_bar2 = QPixmap(self.resource_path('./file_open.png'))
        icon_bar2 = QIcon(pixmap_bar2)
        self.cursorFile.setIcon(icon_bar2)
        self.cursorFile.setIconSize(pixmap_bar2.size())
        self.cursorFile.resize(110, 30)
        self.cursorFile.setStyleSheet('border : 0; background: transparent;')
    ...
    def doAction(self):
        ...
        self.pclosebtn = QPushButton("", self.Action)
        pixmap_bar2 = QPixmap(self.resource_path('./close.png'))
        icon_bar2 = QIcon(pixmap_bar2)
        self.pclosebtn.setIcon(icon_bar2)
        self.pclosebtn.setIconSize(pixmap_bar2.size())
        self.pclosebtn.resize(110, 30)
        self.pclosebtn.setStyleSheet('border : 0; background: transparent;')
